...
namespace VKA.Cupido.Persistence.Migrations
{
    ...
    [Migration("20240822033702_AddedQuestionsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VKA.Cupido.Entities.ContactEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VKA.Cupido.Entities.PairEntity", b =>
                {
                    b.HasOne("VKA.Cupido.Entities.ContactEntity", "FirstPerson")
                        .WithMany()
                        .HasForeignKey("FirstPersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VKA.Cupido.Entities.ContactEntity", "SecondPerson")
                        .WithMany()
